...
local states =
{
    ...
    State {
        ...
        onenter = function(inst, data)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/dogfish/water_emerge_med")
            inst.sg.statemem.endstate = data.endstate
        end,
        onexit = function(inst)
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/dogfish/water_swimemerged_med_LP", "run")
        end,
        onexit = function(inst)
    ...
    State {
        ...
        onenter = function(inst, cb)
            ...
            inst.SoundEmitter:PlaySound("volcano/creatures/swordfish/hit")
        end,
        events = {
    ...
    State {
        ...
        timeline = {
            TimeEvent(2 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("volcano/creatures/swordfish/attack_pre") end),
            ...
            TimeEvent(11 * FRAMES, function(inst)
                ...
                inst.SoundEmitter:PlaySound("volcano/creatures/swordfish/attack")
                --                inst.SoundEmitter:PlaySound("volcano/creatures/swordfish_sword")
            end),
