...
return Class(function(self, inst)
    ...
    --[[ Custom functions ]]
    --------------------------------------------------------------------------
    local function OnUnderWaterChanged(src, underwater)
        ...
        --73BA9B Ocean Green | 008148 Sea Green | 88BB92 Dark Sea Green | 49a078 | 9cc5a1 -> kelp forest
        --- 23B5D3 | 279AF1

        if self.underwater then
            OnOverrideAmbientLighting(true, Point(255 / 255, 255 / 255, 255 / 255))
            --OnOverrideAmbientLighting(true, Point(196 / 255, 255 / 255, 231 / 255))
        else
            OnOverrideAmbientLighting(true, Point(200 / 255, 200 / 255, 200 / 255))
    ...
    inst:ListenForEvent("underwaterchanged", OnUnderWaterChanged)
